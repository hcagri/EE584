...
def main():
    ...
    parser.add_argument('tracker_name',type=str, default ='keep_track' , help='Name of tracking method.')
    ...
    parser.add_argument('--sequence', type=str, default=1, help='Sequence number or name.')
    ...
    run_tracker('keep_track', 'default', None, 'got10k_val', 1, 0,
                0, {'use_visdom': False, 'server': '127.0.0.1', 'port': 8097})
