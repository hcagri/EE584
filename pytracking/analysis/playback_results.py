...
class Display:
    ...
    def show(self, image, bb_list, trackers, gt=None, id=None):
        self.ax.cla()
        ...
        plt.savefig(f'/Users/hcagri/Documents/METU-Master/Term II/EE 584/project/pytracking/test/{id}.png')
...
def playback_results(trackers, sequence):
    ...
    while display.active:
        ...
        display.show(image, tracker_results[frame_number], tracker_names, id=i)
        i+=1
        time.sleep(0.01)
